...
export default function SignupSuccessPage() {
  return (
    <div className="bg-surface border border-border rounded-xl p-8 text-center">
      ...
      <h1 className="text-3xl font-bold text-fg tracking-tight mb-1.5">You&apos;re in.</h1>
      <p className="text-sm text-fg-3 mb-8">Your 14-day trial just started.</p>

      {/* Get the app */}
      <div className="bg-surface-2 border border-border rounded-lg p-5 text-left mb-6">
        <div className="flex items-start gap-3 mb-3">
          <Smartphone className="w-5 h-5 text-sky mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-fg-3 mb-0.5">Next: Get the app.</p>
            <p className="text-sm text-fg-2">The logbook lives on your phone. Web is read-only.</p>
          </div>
        </div>
      ...
      <div className="border-t border-border pt-5">
        <Link
          href="/dashboard"
          className="text-sm text-sky hover:text-sky/80 inline-flex items-center gap-1"
        >
          Go to web logbook →
        </Link>
      </div>
