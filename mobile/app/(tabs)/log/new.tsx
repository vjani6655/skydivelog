      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        >
          ...
          {step === 4 && (<>
            ...
            <Label text="LICENCE #" />
            <TextInput style={[styles.input, errors.signerLicence ? styles.inputError : null]} value={signerLicence} onChangeText={v => { setSignerLicence(v); setErrors(e => ({ ...e, signerLicence: '' })); }} placeholder="B-237 or D-1897" placeholderTextColor={colors.fg3} autoCapitalize="characters" autoCorrect={false} onFocus={() => setTimeout(() => scrollRef.current?.scrollToEnd({ animated: true }), 100)} />
