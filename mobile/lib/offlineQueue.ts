...
export function queuedToJumpFull(item: QueuedJump): JumpFull {
  ...
  return {
    ...
    jump_stage: p.jump_stage ?? null,
    canopy_type: p.canopy_type ?? null,
    canopy_gear_id: p.canopy_gear_id ?? null,
    people_on_jump: p.people_on_jump ?? null,
    aad_fired: p.aad_fired ?? false,
    reserve_deployed: p.reserve_deployed ?? false,
    planned_objectives: p.planned_objectives ?? null,
    planned_manoeuvres: p.planned_manoeuvres ?? null,
